...
public class BranchValidator implements ConstraintValidator<BranchValid, String> {
    private Enum<Branch>[] enumConstants;

    @Override
    public void initialize(BranchValid constraintAnnotation) {
